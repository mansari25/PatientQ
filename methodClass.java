...
public class methodClass {
	...
	public static String Pat_Comments;
	...
	public static void addDatabase(String name){
		try{  
			...
			"jdbc:mysql://localhost:3306?autoReconnect=true&useSSL=false","root","Ma@151786");  
	...
	public static void addTable(String dbName, String tName){
		try{  
			Class.forName("com.mysql.jdbc.Driver");  
			Connection con=DriverManager.getConnection(  
			"jdbc:mysql://localhost:3306/?autoReconnect=true&useSSL=false"+dbName+"","root","Ma@151786");  
	...
	public static int updateIDNum(){
		...
		try{  
			Class.forName("com.mysql.jdbc.Driver");  
			Connection con=DriverManager.getConnection(  
			"jdbc:mysql://localhost:3306/demo?autoReconnect=true&useSSL=false","root","Ma@151786");  
	...
	public static void addEntry(String Pat_FName, String Pat_LName ,String Pat_MName, String Pat_StreetAddrs, String Pat_City, String Pat_State, String Pat_Height, String Pat_Weight, String Pat_DOB ,String Pat_Priority, String Pat_Comments){
		try{  
			Class.forName("com.mysql.jdbc.Driver");  
			Connection con=DriverManager.getConnection(  
			"jdbc:mysql://localhost:3306/demo?autoReconnect=true&useSSL=false","root","Ma@151786");  
			...
			String add = "INSERT INTO Pat_List VALUES ('"+Patient_ID+"', '"+Pat_FName+"', '"+Pat_MName+"', '"+Pat_LName+"', '"+Pat_StreetAddrs+"', '"+Pat_City+"', '" + Pat_State+"', '"+Pat_Height+"', '"+Pat_Weight+"', '"+Pat_DOB+"', '"+Pat_Priority+"', '"+Pat_Comments+"');";
			stmt.executeUpdate(add);
			con.close();
